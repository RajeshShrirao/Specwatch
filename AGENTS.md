...
- `ANTHROPIC_API_KEY`: Anthropic API key (default model: Codex-haiku-4-5-20251002)
- `OPENROUTER_API_KEY`: OpenRouter API key (default model: anthropic/Codex-4.5-haiku-20250929)
